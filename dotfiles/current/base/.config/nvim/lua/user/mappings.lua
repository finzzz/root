...
return {
  n = {
    ...
    ["<leader>th"] = { "<cmd> silent !tmux split-window -v -c %:p:h<cr>", desc = "Tmux horizontal split" },
    ["<leader>tv"] = { "<cmd> silent !tmux split-window -h -c %:p:h<cr>", desc = "Tmux vertical split" },
  ...
  x = {
    ["<leader>a"]        = { "<Plug>(EasyAlign)", desc = "Easy Align <char>" },
    ["<leader><bslash>"] = { "<Plug>(EasyAlign)*<bar><cr>", desc = "Easy Align |" },
    ["<leader>="]        = { "<Plug>(EasyAlign)*=<cr>", desc = "Easy Align =" },
  },
}
